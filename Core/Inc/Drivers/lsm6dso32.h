...
#define __weak __attribute__((weak))
    ...
    int32_t lsm6dso32_read_reg(const stmdev_ctx_t *ctx, uint8_t reg,
                               uint8_t *data,
                               uint16_t len);
    int32_t lsm6dso32_write_reg(const stmdev_ctx_t *ctx, uint8_t reg,
                                uint8_t *data,
                                uint16_t len);
    ...
    int32_t lsm6dso32_temperature_raw_get(const stmdev_ctx_t *ctx,
                                          int16_t *val);
    ...
    int32_t lsm6dso32_ln_pg_write_byte(const stmdev_ctx_t *ctx, uint16_t address,
                                       uint8_t *val);
    ...
    int32_t lsm6dso32_xl_fast_settling_set(const stmdev_ctx_t *ctx,
                                           uint8_t val);
    ...
    int32_t lsm6dso32_spi_mode_set(const stmdev_ctx_t *ctx,
                                   lsm6dso32_sim_t val);
    ...
    int32_t lsm6dso32_tap_threshold_x_get(const stmdev_ctx_t *ctx,
                                          uint8_t *val);
    ...
    int32_t lsm6dso32_tap_threshold_y_get(const stmdev_ctx_t *ctx,
                                          uint8_t *val);

    int32_t lsm6dso32_tap_threshold_z_set(const stmdev_ctx_t *ctx, uint8_t val);
    int32_t lsm6dso32_tap_threshold_z_get(const stmdev_ctx_t *ctx,
                                          uint8_t *val);
    ...
    int32_t lsm6dso32_fifo_watermark_get(const stmdev_ctx_t *ctx,
                                         uint16_t *val);
    ...
    int32_t lsm6dso32_fifo_stop_on_wtm_set(const stmdev_ctx_t *ctx,
                                           uint8_t val);
    ...
    int32_t lsm6dso32_fifo_pedo_batch_get(const stmdev_ctx_t *ctx,
                                          uint8_t *val);

    int32_t lsm6dso32_sh_batch_slave_0_set(const stmdev_ctx_t *ctx,
                                           uint8_t val);
    int32_t lsm6dso32_sh_batch_slave_0_get(const stmdev_ctx_t *ctx,
                                           uint8_t *val);

    int32_t lsm6dso32_sh_batch_slave_1_set(const stmdev_ctx_t *ctx,
                                           uint8_t val);
    int32_t lsm6dso32_sh_batch_slave_1_get(const stmdev_ctx_t *ctx,
                                           uint8_t *val);

    int32_t lsm6dso32_sh_batch_slave_2_set(const stmdev_ctx_t *ctx,
                                           uint8_t val);
    int32_t lsm6dso32_sh_batch_slave_2_get(const stmdev_ctx_t *ctx,
                                           uint8_t *val);

    int32_t lsm6dso32_sh_batch_slave_3_set(const stmdev_ctx_t *ctx,
                                           uint8_t val);
    ...
    int32_t lsm6dso32_den_mark_axis_x_get(const stmdev_ctx_t *ctx,
                                          uint8_t *val);

    int32_t lsm6dso32_den_mark_axis_y_set(const stmdev_ctx_t *ctx, uint8_t val);
    int32_t lsm6dso32_den_mark_axis_y_get(const stmdev_ctx_t *ctx,
                                          uint8_t *val);

    int32_t lsm6dso32_den_mark_axis_z_set(const stmdev_ctx_t *ctx, uint8_t val);
    int32_t lsm6dso32_den_mark_axis_z_get(const stmdev_ctx_t *ctx,
                                          uint8_t *val);
    ...
    int32_t lsm6dso32_mag_sensitivity_set(const stmdev_ctx_t *ctx,
                                          uint16_t val);
    ...
    int32_t lsm6dso32_sh_pass_through_get(const stmdev_ctx_t *ctx,
                                          uint8_t *val);
