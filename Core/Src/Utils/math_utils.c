...
float pressureToAltitude(float pressure_pa, float sea_level_pa)
{
    // The exponent 1/5.255 is approx 0.190263f
    return 44330.0f * (1.0f - powf(pressure_pa / sea_level_pa, 0.190263f));
}